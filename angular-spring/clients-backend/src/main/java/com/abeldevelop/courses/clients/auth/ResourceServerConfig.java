...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http
			.authorizeRequests()
				.antMatchers(HttpMethod.GET, "/api/client", "/api/client/page/**", "/api/client/{id}/profile-image", "/images/**").permitAll()
//				.antMatchers(HttpMethod.GET, "/api/client/{id}").hasAnyRole("USER", "ADMIN")
//				.antMatchers(HttpMethod.POST, "/api/client/{id}/profile-image").hasRole("ADMIN")
