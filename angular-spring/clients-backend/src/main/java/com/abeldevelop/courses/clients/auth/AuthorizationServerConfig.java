...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	private final InfoAditionalToken infoAditionalToken;
	
	@Override
	public void configure(AuthorizationServerSecurityConfigurer security) throws Exception {
		security
			.tokenKeyAccess("permitAll()")	//permit all access to endpoint /oauth/token
			.checkTokenAccess("isAuthenticated()") //permit all access to endpoint /oauth/check_token
			;
	}
